package com.lee.lastpass.util; /**
 * Created by universe on 2015/2/13.
 */
...
public class CSVFileUtil {
    ...
    public  ArrayList<Data> getFullData() {
        ArrayList<Data> ret = new ArrayList<Data>();
        try {
            String oneLine = readLine();
            while(oneLine != null) {
                oneLine = readLine();
                String [] oneLineArray = fromCSVLine(oneLine, 7);
                ret.add(new Data(oneLineArray[4], oneLineArray[1], oneLineArray[2]));
            }
        } catch(Exception e) {
    ...
    public  ArrayList<Data> getFullData(String query) {
        ArrayList<Data> ret = new ArrayList<Data>();
        try {
            String oneLine = readLine();
            if(oneLine == null) {
            ...
            Log.i("query", "I am here");
            while(oneLine != null) {
                oneLine = readLine();
                String [] oneLineArray = fromCSVLine(oneLine, 7);
                if(oneLineArray[4].indexOf(query) != -1) {
                    ret.add(new Data(oneLineArray[4], oneLineArray[1], oneLineArray[2]));
                    Log.i("query", query + " ========== " + oneLineArray[4]);
                }
                else{
                    Log.i("query", query + " != " + oneLineArray[4]);
                }
